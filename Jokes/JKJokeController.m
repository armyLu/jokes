...
//    self.tableView.contentInset = UIEdgeInsetsMake(0, 0, 0, 150);
...
- (void)refreshData
{
    ...
    [JKNetworkUtil requestJokeWithJokeType:self.jokeType pageNo:_jokePage success:^(NSDictionary *jsonData) {
        ...
        loadMoreView.frame = CGRectMake(0, 0, self.tableView.frame.size.width, 150);
...
{
    [JKShowImageView showWithImageURL:[jokeModel pic_url]];
}
